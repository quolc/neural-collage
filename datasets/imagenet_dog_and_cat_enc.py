...
class ImageNetDogAndCatEncDataset(chainer.dataset.DatasetMixin):
    ...
    def transform(self, image1, image2):
        image2 = scipy.misc.imresize(image2.transpose(1, 2, 0),
                                    [image1.shape[1], image1.shape[2]], self.resize_method).transpose(2, 0, 1)
...
# generate image_list_dog_and_cat.txt by running this script:
# python imagenet_dog_and_cat_enc.py IMAGE_ROOT_PATH
